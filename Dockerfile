...
RUN apt-get update
RUN apt-get install -y --no-install-recommends build-essential gcc perl wget libcurl-dev git autoconf zlib1g zlib1g-dev libbz2-dev bzip2 liblzma-dev libncurses5-dev
